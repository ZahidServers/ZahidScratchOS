; ===========================================================================
; Copyright (C) 2020 Mohammed Zahid Imtiyaz Wadiwale -- see doc/LICENSE.TXT
;
...
; ===========================================================================
	...
	%DEFINE ZahidScratch_OS_VER '1.2'	; OS version number
	%DEFINE ZahidScratch_OS_API_VER 13	; API version for programs to check
...
; use a ZahidScratch system call without having to know its exact position
...
option_screen:
	...
	os_init_msg		db 'Welcome to the ZahidScratch OS', 0
	os_version_msg		db 'Version ', ZahidScratch_OS_VER, 0

	dialog_string_1		db 'Thanks for trying out ZahidScratch OS!', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot execute ZahidScratch OS kernel!', 0
	kerndlg_string_2	db 'KERNEL is the core of ZahidScratch OS', 0
