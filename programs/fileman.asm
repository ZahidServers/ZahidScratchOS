; -----------------------------------------------------------------------
; Simple file manager for ZahidScratch OS: copy, delete and rename files
; -----------------------------------------------------------------------
	...
	; This is the point used by the disk buffer in the ZahidScratch OS kernel
...
.draw_background:
	...
	.title_msg		db 'Zahid File Manager', 0
