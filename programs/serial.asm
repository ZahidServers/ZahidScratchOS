; ------------------------------------------------------------------
; Minicom-like program for ZahidScratch OS
; ------------------------------------------------------------------
...
;
; Connect the serial cable to your ZahidScratch OS machine and Linux machine.
; Start ZahidScratch OS and run SERIAL.BIN, then start your Linux box with the
; above serial terminal entry. On the ZahidScratch OS machine, you will see a
...
erase_sub:
	...
	start_msg	db 'Zahid minicom -- Press F8 to quit', 13, 10, 'Connecting via serial at 9600 baud...', 13, 10, 13, 10, 0
	finish_msg	db 13, 10, 13, 10, 'Exiting Zahid minicom; press a key to return to ZahidScratch OS', 13, 10, 0
