...
;
; This Bootloader scans the FAT12
; floppy for KERNEL.BIN (the ZahidScratch kernel), loads it and executes it.
...
OEMLabel		db "ZAHIDSCRATCHBOOT"	; Disk label
...
VolumeLabel		db "ZahidS OS  "; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "KERNEL  BIN"	; ZahidScratch OS kernel filename
